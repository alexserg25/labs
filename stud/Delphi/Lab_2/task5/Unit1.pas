...
begin
  ...
  // Вывод результата, от состояния дискриминанта
  if D < 0 then
  begin
    // Вывод дискриминанта.
    lblDiscriminant.Caption := 'Дискриминант = ' + FloatToStr(D)
        + '. Корней нет!';
    // Очистка вывоад x1 и x2
    lblX1.Caption := '';
    lblX2.Caption := '';
  ...
  begin
    ...
    x1 := (-b + sqrt(D))/(2 * a);
    // Вывод первого корня уравнения.
    lblX1.Caption := 'X1 = ' + FloatToStr(x1);
    // Очиства вывода второго корня уравнения.
    lblX2.Caption := '';
  end;
...
begin
  // Очистка содержимого lable вывода корней уровнения
  lblX1.Caption := '';
  lblX2.Caption := '';
end;
